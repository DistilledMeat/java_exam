...
public class JMenuBarDemo implements ActionListener, ItemListener {
	...
	protected static ImageIcon createImageIcon(String path) {
		java.net.URL imgURL = JMenuBarDemo.class.getResource(path);
		if (imgURL != null) {
	...
	private static void createGUI() {
		...
		JMenuBarDemo app = new JMenuBarDemo();
